from groundingdino.util.inference import load_model, predict, annotate, predict_batch
...
class GroundingDINO_detector:
    ...
    def __init__(self,config):
        ...
        self.model = load_model(
            ".\Vision_models/GroundingDINO/groundingdino/config/GroundingDINO_SwinT_OGC.py", 
            ".\Vision_models/GroundingDINO/weight/groundingdino_swint_ogc.pth"
        )
