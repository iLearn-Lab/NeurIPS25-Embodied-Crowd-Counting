...
import cv2
import numpy as np
from Agent.Prompts import TOP_DOWN_3
...
class Qwen:
    ...
    def __init__(self, config):
        ...
        if config['OurExplore']['LLM_name'] == 'Qwen':
            self.model = "qwen-vl-max-latest"
        elif config['OurExplore']['LLM_name'] == 'Qwen7B':
    ...
    def get_resopnse(self,request,img_bgr:list, print_result = False):
    ...
    def LLMChooseDown2(self, images, llm_score_thresh, print_result = True):
        ...
        content = self.get_resopnse(TOP_DOWN_3, images, print_result)
